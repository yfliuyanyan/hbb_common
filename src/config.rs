...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("SunshineDesk".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["10.65.189.185"];
pub const RS_PUB_KEY: &str = "OGS3Niry8LBYwR4LMfMmndwhsg5B0TmD2IUkyQrZ+Yg=";
